...
export function Contact() {
  ...
  useGsap((gsap) => {
    ...
    const locationSec = containerRef.current?.querySelector('[data-location-section]');
    if (locationSec) {
      gsap.fromTo(
        locationSec,
        { opacity: 0, y: 30 },
        { opacity: 1, y: 0, duration: 0.85, ease: GSAP_EASING.editorial }
      );
    }
  }, [], containerRef);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pt-6">
            ...
            <div data-contact-col className="lg:col-span-5 space-y-8">
              <div className="bg-mono-950 text-mono-0 p-8 rounded-xs space-y-6">
                ...
                <h2 className="text-heading-md md:text-heading-lg font-semibold text-mono-0">
